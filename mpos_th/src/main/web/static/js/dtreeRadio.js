...
function dTree(objName, iPath, formId) {
	...
	this.icon = {
		...
		root				: '..../static/images/img/base.gif',

		folder			: '../static/images/img/folder.gif',

		folderOpen	: '../static/images/img/folderopen.gif',

		node				: '../static/images/img/page.gif',

		empty				: '../static/images/img/empty.gif',

		line				: '../static/images/img/line.gif',

		join				: '../static/images/img/join.gif',

		joinBottom	: '../static/images/img/joinbottom.gif',

		plus				: '../static/images/img/plus.gif',

		plusBottom	: '../static/images/img/plusbottom.gif',

		minus				: '../static/images/img/minus.gif',

		minusBottom	: '../static/images/img/minusbottom.gif',

		nlPlus			: '../static/images/img/nolines_plus.gif',

		nlMinus			: '../static/images/img/nolines_minus.gif'
...
dTree.prototype.node = function(node, nodeId) {
	...
	if(this.config.useCheckBox && nodeId!=0){
		...
		str += '<input type="radio" name="id" id="c'+this.parEnum+'" onClick="caBox(\''+this.formId+'\',\'c'+this.parEnum+'\')" value="' + node.id +'" class="cx"/>';
	}
	...
	Array.prototype.pop = function array_pop() {
		...
		function isCheckedByRec( form ,regx){
			...
			for (var i=0; i<form.elements.length; i++) {
				...
				if (element.name == "id" && element.type=='radi'){
					// isChecked
