...
<script type="text/javascript">
	...
	function saveData(t){
		...
		top.$('#mainIframe').contents().find("#tCompanyId").val(id);
		top.$('#mainIframe').contents().find("#tCompanyId_name").val(name);
		top.$("#tCompanyId").modal('hide');
	}
</script>
...
<input class="hide" name="dialog" value="true">
				<form:input class="query-input" path="companyDesc" placeholder="公司描述" />
<input class="hide" name="dialog" value="true">
