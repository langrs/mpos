...
<body>
	...
	<form:form id="dataForm" modelAttribute="authRes"
		action="${contextPath}/authRes/save.do" method="post" role="form">
		<section class="row">
				...
				<tbody>
						...
						<tr>
							...
							<td>
								...
								<form:input id="navId" path="navId"
