...
<body>
	...
	<form:form id="dataForm" modelAttribute="tRole"
		action="${contextPath}/tRole/save.do" method="post" role="form">
		<section class="row">
				...
				<tbody>
						...
						<tr>
							...
							<td>
								...
								<form:input id="roleType" path="roleType"
						...
						<tr>
							...
							<td>
								...
								<form:input id="roleNo" path="roleNo"
											class="input-text-lg required" />
						...
						<tr>
							...
							<td>
								...
								<td><input value="${tRole.shopIdObj.name}" id="tShopId_name"
								...
								onclick="top.$('#tShopId').modal('show');" value="选择"></td>
                                                     ...
                                                     <input name="createTime" class="hidden" value="<fmt:formatDate value="${tRole.createTime}" pattern="yyyy-MM-dd HH:mm:ss" />"/>
