...
<script type="text/javascript">
	...
	function saveData(t){
		...
		top.$('#mainIframe').contents().find("#tCodeId").val(id);
		top.$('#mainIframe').contents().find("#tCodeId_name").val(name);
		top.$("#tCodeId").modal('hide');
	}
</script>
...
<input class="hide" name="dialog" value="true">
				<form:input class="query-input" path="codeNo" placeholder="代码编码" />
<input class="hide" name="dialog" value="true">
				<form:input class="query-input" path="name" placeholder="代码名称" />
<input class="hide" name="dialog" value="true">
				<form:input class="query-input" path="isSys" placeholder="是否系统代码" />
<input class="hide" name="dialog" value="true">
				<form:input class="query-input" path="codeAttr" placeholder="参数属性" />
<input class="hide" name="dialog" value="true">
