...
<body>
	...
	<form:form id="dataForm" modelAttribute="roleUser"
		action="${contextPath}/roleUser/save.do" method="post" role="form">
		<section class="row">
			...
			<table cellspacing="0" cellpadding="0" class="maoye-table mgtop10">
				<tbody>
							<form:hidden path="id"/>
								...
								<td><input value="${roleUser.useridObj.name}" id="userid_name"
						...
						<tr>
							...
							<td>
								...
								<form:input id="roleId" path="roleId"
