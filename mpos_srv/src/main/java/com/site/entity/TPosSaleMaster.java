...
import java.io.Serializable;
 /**
 * FUNCTION:TPosSaleMaster Entity
 * COMPANY:SZUNIC
 * AUTHOR:LZM
 */
 
public class TPosSaleMaster implements Serializable
{
	...
	// 
	protected Double posOrgAmt;
	// 
	protected Double posTotalAmt;
	// 
	protected Double posIntegral;
	// 
	protected String custName;
	// 
	protected String custMan;
	// 
	protected String custAddress;
	// 
	protected String custTel;
	// 
	protected String custRequest;
	// 
	protected Date posOrderTime;
	// 
	protected Date posSendTime;
	// 
	protected String dealOrder;
	// 
	protected String posMemo;
	// 
	protected String posBytxt1;
	// 
	protected String posBytxt2;
	// 
	protected String posBytxt3;
	// 
	...
	// 
	protected String fuTimes;
	// 
	protected String posOrderIsSend;
	// 
	protected String posOrderStatus;
	// 
	protected String posOrderSender;
	// 
	protected String custNo;
	// 
	protected String tourGrp;
	// 
	protected String tourNo;
	// 
	protected String guideNo;
	// 
	...
	// 
	protected String cfFrom;
	// 
	protected String cfYs;
	// 
	protected String cfPyr;
	// 
	protected String cfFyr;
	// 
	protected String cfZd;
	// 
	protected String cfNo;
	...
	public void setFuTimes(String fuTimes)
	{
		this.fuTimes = fuTimes;
	}
	public String getFuTimes()
	{
		return this.fuTimes;
	}
